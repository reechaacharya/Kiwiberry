...
## SBATCH -p shared
#SBATCH --job-name="mockref"
#SBATCH --output=genome.output
...
perl GBS-SNP-CROP-4.pl -vs $HOME/.conda/envs/reecha/bin/vsearch -d SE -b barcodesID.txt -rl 150 -t 10 -cl consout -id 0.93 -db 1 -min 32 -MR GSC.MR
